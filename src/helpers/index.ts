...
export const getConfigProperties = (): { [config: string]: any } => {
  return vscode.extensions.getExtension('mikekscholz.pop-icon-theme')
...
export const getThemeConfig = (section: string) => {
  return getConfig('pop-icon-theme').inspect(section);
};
...
export const setThemeConfig = (
  ...
  return getConfig('pop-icon-theme').update(section, value, global);
};
...
export const getExtensionPath = () =>
  vscode.extensions.getExtension('mikekscholz.pop-icon-theme')
    .extensionPath;
