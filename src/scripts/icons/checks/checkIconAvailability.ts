...
const handleErrors = () => {
    ...
    if (amountOfErrors > 0) {
        console.log('> POP! Icon Theme:', painter.red(`Found ${amountOfErrors} error(s) in the icon configuration!`));
    } else {
        console.log('> POP! Icon Theme:', painter.green(`Passed icon availability checks!`));
    }
